...
public interface Constants {
    ...
    String LABEL_EVENT_PORTAL_DOMAIN = "CLEVERTAP_EVENT_PORTAL_DOMAIN";
    ...
    String LABEL_USE_CUSTOM_DEVICE_ID = "CLEVERTAP_USE_CUSTOM_DEVICE_ID";
    ...
    Set<String> PROFILE_IDENTIFIER_KEYS = new HashSet<>(Arrays.asList("Identity", "Email", "FBID", "GPID"));
